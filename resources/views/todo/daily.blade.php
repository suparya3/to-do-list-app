...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-calendar-day me-2"></i>Daily Tasks</h2>
    ...
    <div class="card">
        <div class="card-body text-center py-5">
            ...
            <h4 class="text-muted">Tidak ada tugas untuk hari ini</h4>
            <p class="text-muted mb-4">Silakan tambah tugas baru atau pilih tanggal lain</p>
